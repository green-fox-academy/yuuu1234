...
namespace FoxCoin.Migrations
{
    ...
    [Migration("20181207172805_AddMoreUser")]
            ...
            modelBuilder.Entity("FoxCoin.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new { TransactionId = 1L, Amount = 0m, ReceiverId = 2L, SenderId = 1L, Timestamp = new DateTime(2018, 12, 7, 17, 28, 5, 417, DateTimeKind.Utc) }
                    );
                });
