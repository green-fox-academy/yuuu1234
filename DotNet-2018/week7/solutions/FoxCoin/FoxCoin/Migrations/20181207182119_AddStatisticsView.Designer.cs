...
namespace FoxCoin.Migrations
{
    ...
    [Migration("20181207182119_AddStatisticsView")]
    partial class AddStatisticsView
    {
            ...
            modelBuilder.Entity("FoxCoin.Models.Transaction", b =>
                {
                    ...
                    b.HasData(
                        new { TransactionId = 1L, Amount = 0m, ReceiverId = 2L, SenderId = 1L, Timestamp = new DateTime(2018, 12, 7, 18, 21, 19, 119, DateTimeKind.Utc) }
                    );
                });
